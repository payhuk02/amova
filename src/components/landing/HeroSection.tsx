...
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-[7.5rem]">
    ...
    <div className="container relative z-10 text-center py-20 md:py-32 px-6">
      <div className="reveal-up max-w-3xl mx-auto">
        ...
        <h1 className="font-display text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-light leading-[0.95] mb-8">
          Des rencontres
          <br />
          <span className="text-gradient-copper font-medium italic">qui comptent</span>
        </h1>
